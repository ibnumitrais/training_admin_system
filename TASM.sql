...
/*  Created On : 22-Aug-2017 15:27:58 				*/
...
(
	...
	[roles_code] char(10) NULL,
	[roles_name] varchar(50) NULL,
	[roles_desciption] varchar(255) NULL
)
GO
...
(
	...
	[user_account_name] varchar(50) NULL,
...
ALTER TABLE [User] ADD CONSTRAINT [FK_User_Division]
	FOREIGN KEY ([division_id]) REFERENCES [Division] ([devision_id]) ON DELETE No Action ON UPDATE No Action
GO
...
ALTER TABLE [User_Role] ADD CONSTRAINT [FK_User_Role_Roles]
	FOREIGN KEY ([roles_id]) REFERENCES [Roles] ([roles_id]) ON DELETE No Action ON UPDATE No Action
GO
